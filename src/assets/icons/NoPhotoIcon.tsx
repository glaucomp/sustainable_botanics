...
const NoPhotoIcon = ({classes = 'text-white'}: Props) => (
  <Svg viewBox="796 796 200 200" width="120px" height="120px" enable-background="new 796 796 200 200" fill="currentColor" className={classes}>
    <Circle
      opacity="0.5"
      cx="12"
      cy="9"
